...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme:
            ColorScheme.fromSeed(seedColor: Color.fromARGB(221, 231, 89, 6)),
        useMaterial3: true,
      ),
      home: addproduct(),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(221, 78, 190, 241),
      ),
      // เพิ่มภาพพื้นหลัง
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(221, 62, 185, 24), // กำหนดสีพื้นหลัง
                      ),
                      child: Text(
                        'บันทึกสินค้า',
                        style: TextStyle(
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color.fromARGB(221, 255, 14, 34), // กำหนดสีพื้นหลัง
                      ),
                      child: Text(
                        'เคลียร์ข้อมูล',
                        style: TextStyle(
